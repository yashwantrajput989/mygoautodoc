    ...
    <div className="flex flex-col h-full bg-background overflow-hidden">
      ...
      <header className="px-6 py-4 border-b border-border bg-card flex items-center justify-between shrink-0 shadow-sm z-10">
        ...
        <div className="flex gap-2">
          ...
          {!isSuccess && !currentDoc?.is_pending && (
            <button
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-6">
            {isBodyOnly ? (
              ...
              <div className="fiori-card flex flex-col overflow-hidden bg-muted/10 min-h-[600px] shadow-sm rounded-xl animate-in fade-in duration-300">
